...
## Reusable prep material to build here over time
- `system-design-checklist.md` — a go-to framework for design rounds (for software/data/infra):
  clarify the **user/API contract first**, then commit to one architecture, then data model,
  multi-tenancy, scaling/regionalization, and trade-offs.
...
_(Empty — populate as you prepare for technical rounds.)_
